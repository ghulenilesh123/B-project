...
import {  myactivete, mychildactivete, mydeactive, myGuardsGuard, mymatch, myresolver } from 'src/app/guards/my-guards.guard';

const rot: Routes = [
  { path: "gaurd_1", component: Gaurd1Component, canActivate: [myactivete] },
